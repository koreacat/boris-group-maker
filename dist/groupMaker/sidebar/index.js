...
var Sidebar = function (_a) {
    ...
    return (_jsx("aside", __assign({ className: cx('sidebarArea') }, { children: _jsxs("div", __assign({ className: cx('sidebarWrap') }, { children: [_jsxs("div", __assign({ className: cx('inputArea') }, { children: [_jsx("span", __assign({ className: cx('title') }, { children: "\uCD1D \uC778\uC6D0 \uC218" })), _jsx("div", __assign({ className: cx('inputWrap', { blinking: data.length === 0 }) }, { children: _jsx("input", { className: cx('input'), type: "number", min: 0, max: 500, value: data.length, onChange: handleChangeNumber, disabled: mode === 'RESULT' }) }))] })), _jsxs("div", __assign({ className: cx('inputArea') }, { children: [_jsx("span", __assign({ className: cx('title') }, { children: "\uBAA8\uB460 \uAD6C\uC131 \uBC29\uC2DD" })), _jsxs("div", __assign({ className: cx('radioArea') }, { children: [_jsxs("label", __assign({ className: cx('radioWrap') }, { children: [_jsx("input", { className: cx('radio'), type: "radio", name: "groupType", value: "NUMBER", onChange: handleChangeGroupType, checked: groupType === 'NUMBER', disabled: mode === 'RESULT' }), _jsx("span", __assign({ className: cx('radioTitle') }, { children: "\uD55C \uBAA8\uB460\uB2F9 \uBAA8\uB460\uC6D0 \uC218" }))] })), _jsxs("label", __assign({ className: cx('radioWrap') }, { children: [_jsx("input", { className: cx('radio'), type: "radio", name: "groupType", value: "GROUP", onChange: handleChangeGroupType, checked: groupType === 'GROUP', disabled: mode === 'RESULT' }), _jsx("span", __assign({ className: cx('radioTitle') }, { children: "\uCD1D \uBAA8\uB460 \uC218" }))] }))] }))] })), _jsxs("div", __assign({ className: cx('inputArea') }, { children: [_jsx("span", __assign({ className: cx('title') }, { children: groupType === 'NUMBER' ? '모둠원 수' : '모둠 수' })), _jsx("div", __assign({ className: cx('inputWrap', { blinking: groupNumber === 0 }) }, { children: _jsx("input", { className: cx('input'), type: "number", min: 0, max: 500, value: groupNumber, onChange: handleChangeGroupNumber, disabled: mode === 'RESULT' }) }))] })), _jsxs("div", __assign({ className: cx('buttonWrap') }, { children: [mode === 'LIST' &&
                            _jsx("button", __assign({ type: "button", className: cx('button'), onClick: creatGroup }, { children: "\uB9CC\uB4E4\uAE30" })), mode === 'RESULT' &&
                            _jsx("button", __assign({ type: "button", className: cx('button', 'reset'), onClick: reset }, { children: "\uCD08\uAE30\uD654" }))] })), _jsxs("ol", __assign({ className: cx('descWrap') }, { children: [_jsx("strong", __assign({ className: cx('title') }, { children: "\uB3C4\uC6C0\uB9D0" })), _jsx("li", __assign({ className: cx('desc') }, { children: "1. \uCD1D \uC778\uC6D0 \uC218\uB97C \uC22B\uC790\uB85C \uC785\uB825\uD574\uC8FC\uC138\uC694." })), _jsx("li", __assign({ className: cx('desc') }, { children: "2. \uBAA8\uB460 \uAD6C\uC131 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uACE0 \uC218\uB97C \uC785\uB825\uD574\uC8FC\uC138\uC694." })), _jsxs("li", __assign({ className: cx('desc') }, { children: ["3. \uBC88\uD638\uB97C \uD074\uB9AD\uD558\uBA74", ' ', _jsxs("div", __assign({ className: cx('rectTitleWrap') }, { children: [_jsx("div", { className: cx('rect') }), _jsx("span", __assign({ className: cx('title') }, { children: "\uBAA8\uB460\uC6D0" }))] })), "\uC5D0\uC11C", ' ', _jsxs("div", __assign({ className: cx('rectTitleWrap') }, { children: [_jsx("div", { className: cx('rect', 'yellow') }), _jsx("span", __assign({ className: cx('title') }, { children: "\uBAA8\uB460\uC7A5" }))] })), "\uC73C\uB85C \uBC14\uB00C\uACE0, \uD55C \uBC88 \uB354 \uD074\uB9AD\uD558\uBA74 \uBAA8\uB460 \uD3B8\uC131\uC5D0\uC11C", ' ', _jsxs("div", __assign({ className: cx('rectTitleWrap') }, { children: [_jsx("div", { className: cx('rect', 'gray') }), _jsx("span", __assign({ className: cx('title') }, { children: "\uC81C\uC678" }))] })), "\uB429\uB2C8\uB2E4."] })), _jsx("li", __assign({ className: cx('desc') }, { children: "4. \uB9CC\uB4E4\uAE30\uB97C \uD074\uB9AD\uD574\uC8FC\uC138\uC694." }))] }))] })) })));
};
